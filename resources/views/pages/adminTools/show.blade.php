                ...
                <div class="card-body">
                    ...
                    <div class="d-flex flex-center flex-column py-5">
                        ...
                        <div class="symbol symbol-100px symbol-circle mb-7">
                            <img src="{{ asset('images/tools/'.$tool->img) }}" alt="image" />
                    ...
                    <div class="card card-flush mb-6 mb-xl-9">
                        ...
                        <div class="card-header mt-6">
                            ...
                            <div class="card-title flex-column">
                                <h2 class="mb-1">Tool's Details</h2>
                            </div>
                            <!--end::Card title-->
                            <!--begin::Card toolbar-->
                            ...
                            <div id="kt_user_view_details" class="collapse show">
                                <div class="pb-5 fs-6">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-9"><div class="text-gray-600 mt-5">{{ $tool->title ?? '' }}</div></div>
                                    </div>

                                    <div class="row">
                                        <div class="col-md-3"><div class="fw-bold mt-5">Url</div></div>
                                        <div class="col-md-9"><div class="text-gray-600 mt-5">{{ $tool->url ?? '' }}</div></div>
                                    </div>
