<div id="mediaModel1" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-modal="true"
...
<script>
    $(document).ready(function() {
        $('.media_model_card').click(function() {
            ...
            var appendData = '<div class="col-md-3 mb-5"><div class="card"><input type="hidden" name="media_url" id="" value="'+ checkbox.val() +'"><img height="114px" src="'+ checkbox.val() +'" alt=""></div></div>';
