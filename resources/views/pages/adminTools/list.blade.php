    ...
    <div id="ProductModal" class="modal fade show " tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-modal="true" aria-hidden="true" style="color: black;">
        <div class="modal-dialog modal-lg" id="ProductModalDialog">
            <div class="modal-content" id="ProductModalContent">
                ...
                <form name="productForm" method="POST" action="{{ route('tools.store') }}" enctype="multipart/form-data" id="prodForm">
                    @csrf
                    <span class='arrow'>
    ...
    <div id="EditModal" class="modal fade show " tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-modal="true" aria-hidden="true" style="color: black;">
        <div class="modal-dialog modal-lg">
            <div class="modal-content" id="BlogModalData">
                <form name="productForm" method="POST" action="{{ route('toolUpdate') }}" enctype="multipart/form-data" id="prodForm">
                    @csrf
                    <span class='arrow'>
                        <label class='error'></label>
                    </span>
                    ...
                    <div class="modal-body">
                        <div class="" id="ProductModalData">
                            ...
                            <div class="row">
                                <div class="col-lg-12 mb-5">
                                    <label> Title:</label>
                                    <input id="edittitle" type="text" name="title" class="form-control" placeholder="Enter Title" required>
                                </div>

                                <div class="col-lg-12 mb-5">
                                    <label> Url:</label>
                                    <input id="editurl" type="text" name="url" class="form-control" placeholder="Enter url" required>
