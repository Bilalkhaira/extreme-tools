                        ...
                        <div class="card-body p-9 pt-4">
                            ...
                            <div id="kt_user_view_details" class="collapse show">
                                <div class="pb-5 fs-6">
                                    ...
                                    <div class="row">
                                        <div class="col-md-3"><div class="fw-bold mt-5">Blog Slug</div></div>
                                        <div class="col-md-9"><div class="text-gray-600 mt-5">{{ URL::current() }}</div></div>
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-3"><div class="fw-bold mt-5">Categories</div></div>
                                        <div class="col-md-9">
                                            <div class="text-gray-600 mt-5">
                                                @if(!empty($categories))
