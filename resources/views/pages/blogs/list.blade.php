    ...
    <div id="ProductModal" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"
        ...
        <div class="modal-dialog modal-lg" id="ProductModalDialog">
            <div class="modal-content" id="ProductModalContent">
                ...
                <form name="productForm" method="POST" action="{{ route('blogs.store') }}"
                        ...
                        <div class="" id="ProductModalData">
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-12 mb-5">
                                    ...
                                    <textarea name="short_description" class="form-control" cols="12" rows="2"></textarea>
                                </div>
                                <div class="col-lg-12 mb-5">
                                    <label> Select Categories:</label>
                                    <select id="select-categories" name="categories[]" placeholder="Select courses..."
                                ...
                                <div class="col-lg-12 mb-5">
                                    ...
                                    <select id="select-tags" name="tags[]" placeholder="Select courses..."
                                        autocomplete="off" class="form-control" multiple>
                                        @if (!empty($tags))
                                            @foreach ($tags as $tag)
                                ...
                                <div class="col-lg-12 mb-5">
                                    <label> Slug:</label>
                                    <input id="input2" type="text" name="slug" class="form-control"
                                        required>
                                </div>
    ...
    @push('scripts')
        ...
        <script>
            ...
            input1.addEventListener("input", function() {
                ...
                var slug = generateSlug(valueWithSpaces);
                input2.value = slug;
            });
            ...
            // Example usage:
            var titleInput = document.getElementById('input2');
