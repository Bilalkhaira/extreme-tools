...
<div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg menu-state-color fw-semibold py-4 fs-6 w-275px" data-kt-menu="true">
    ...
    <div class="menu-item px-3">
        <div class="menu-content d-flex align-items-center px-3">
            ...
            <img alt="Logo" src="<?php echo e(asset('images/profile/'.Auth::user()->avatar)); ?>"/>
            <?php else: ?>
            ...
            <div class="d-flex flex-column">
                <div class="fw-bold d-flex align-items-center fs-5"><?php echo e(Auth::user()->name); ?>
                    ...
                    <span class="badge badge-light-success fw-bold fs-8 px-2 py-1 ms-2"><?php echo e(Auth::user()->getRoleNames()[0]); ?></span>
                </div>
    ...
    <div class="menu-item px-5">
        <a href="<?php echo e(route('user-management.users.show', auth()->user())); ?>" class="menu-link px-5">My Profile</a>
    </div>
    <!--end::Menu item-->
    <!--begin::Menu item-->
...
<?php /**PATH /Users/zubairmohsin/code/sites/veconekt/extreme-tools-admin/resources/views/partials/menus/_user-account-menu.blade.php ENDPATH**/ ?>