...
unset($__errorArgs, $__bag); ?>
                            ...
                            <?php $__currentLoopData = $roles; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $role): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                ...
                                <div class="d-flex fv-row">
                                    ...
                                    <div class="form-check form-check-custom form-check-solid">
                                        <!--begin::Input-->
                                        <input class="form-check-input me-3" id="kt_modal_update_role_option_<?php echo e($role->id); ?>" wire:model.defer="role" name="role" type="radio" value="<?php echo e($role->name); ?>" checked="checked"/>
                                        <!--end::Input-->
                                        <!--begin::Label-->
    ...
    <!--end::Modal dialog-->
</div><?php /**PATH /Users/zubairmohsin/code/sites/veconekt/extreme-tools-admin/resources/views/livewire/user/add-user-modal.blade.php ENDPATH**/ ?>