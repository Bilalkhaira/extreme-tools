...
<?php $component->withAttributes([]); ?>
    ...
    <form class="form w-100" novalidate="novalidate" id="kt_sign_in_form" data-kt-redirect-url="<?php echo e(route('dashboard')); ?>" action="<?php echo e(route('login')); ?>">
        ...
        <div class="d-flex flex-stack flex-wrap gap-3 fs-base fw-semibold mb-8">
            ...
            <!--begin::Link-->
            <a href="<?php echo e(route('password.request')); ?>" class="link-primary displayNone">
                Forgot Password ?
            </a>
            <!--end::Link-->
        </div>
...
<?php endif; ?>
<?php /**PATH /Users/zubairmohsin/code/sites/veconekt/extreme-tools-admin/resources/views/pages/auth/login.blade.php ENDPATH**/ ?>